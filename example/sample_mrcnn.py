...
if __name__ == "__main__":
    ...
    mode_info = retrieve_model_by_name(architecture_name='MRCNN', framework=Framework.TENSORFLOW,engine=Engine.TFS) # retrieve model information

    profiler = Profiler(model_info=mode_info, server_name='tfs', inspector=tfs_client)
    profiler.diagnose() # profile batch size 32 in all the availavle devices